...
!function () {
    ...
    window.Framework7 = function (a) {
        ...
        var p = function (e, a) {
            ...
            s.history = [];
            var u = c, f = i.params.pushStateSeparator, m = i.params.pushStateRoot;
            ...
            var v, w, b, C, y, x, T, k, S, P, M, I = !1, O = !1, E = {}, L = [], D = [], B = !0, N = [], A = [];
            if (s.handleTouchStart = function (e) {
                    ...
                    var n = {activePage: L[0], previousPage: D[0], activeNavbar: N[0], previousNavbar: A[0]};
                    if (t) {
                ...
                if (z)i.router.load(s, {url: z, animatePages: H, pushState: !1}); else if (c.indexOf(f + "#") >= 0) {
                    var R = history.state;
            ...
            if (!i.params.material) {
                ...
                a.each(function () {
                    ...
                    if (!e.hasClass("cached")) {
                        var a, t, n = e.find(i.rtl ? ".right" : ".left"), r = e.find(i.rtl ? ".left" : ".right"), s = e.find(".center"), l = e.find(".subnavbar"), p = 0 === n.length, d = 0 === r.length, c = p ? 0 : n.outerWidth(!0), u = d ? 0 : r.outerWidth(!0), f = s.outerWidth(!0), m = e.styles(), h = e[0].offsetWidth - parseInt(m.paddingLeft, 10) - parseInt(m.paddingRight, 10), g = e.hasClass("navbar-on-left");
                        ...
                        var b = t;
                        i.rtl && p && d && s.length > 0 && (b = -b), s.css({left: b + "px"})
                    }
                })
            }
        ...
        var d = function (e, a) {
            ...
            }], c = {}, u = 0; u < d.length; u++)for (var f = d[u].letters, m = 0; m < f.length; m++)c[f[m]] = d[u].base;
        ...
        i.triggerPageCallbacks = function (e, a, t) {
            ...
            if (!t.f7PageInitialized || e.params.domCache) {
                ...
                t.f7PageInitialized = !0, t.f7PageData = n, !e || a.preloadOnly || a.reloadPrevious || (o(e.container).attr("data-page", n.name), e.activePage = n), i.pluginHook("pageBeforeInit", n), i.params.onPageBeforeInit && i.params.onPageBeforeInit(i, n), i.triggerPageCallbacks("beforeInit", n.name, n), o(n.container).trigger("pageBeforeInit", {page: n}), i.initPage(t), i.pluginHook("pageInit", n), i.params.onPageInit && i.params.onPageInit(i, n), i.triggerPageCallbacks("init", n.name, n), o(n.container).trigger("pageInit", {page: n})
            }
            ...
            temporaryDom: document.createElement("div"), findElement: function (e, a, t, n) {
                ...
                if ("string" == typeof s ? r ? i.template7Cache[r] ? n = l.cache[r] : (n = l.compile(s), l.cache[r] = n) : n = l.compile(s) : u && (n = u), d)t = d; else {
                    ...
                    if (!t && u && l.templates)for (var w in l.templates)l.templates[w] === u && (t = l.data[w]);
                    t || (t = {})
                }
                if (n && t) {
            ...
            a = a || {};
            var n, r, s, l, p, d, c, u, f, m = a.url, h = a.content, g = {content: a.content}, v = a.template, w = a.pageName, b = o(e.container), C = o(e.pagesContainer), y = a.animatePages, x = "undefined" == typeof m && h || v, T = a.pushState;
            ...
            if (e.params.uniqueHistory) {
                var E = e.history, L = m;
                if (e.params.uniqueHistoryIgnoreGetParameters)for (E = [], L = m.split("?")[0], l = 0; l < e.history.length; l++)E.push(e.history[l].split("?")[0]);
            ...
            a = a || {};
            var l, p, d, c, u, f, m, h = a.url, g = a.content, v = {content: a.content}, w = a.template, b = a.animatePages, C = a.preloadOnly, y = a.pushState, x = (a.ignoreCache, a.force), T = a.pageName, k = o(e.container), S = o(e.pagesContainer), P = S.children(".page:not(.cached)"), M = !0;
        ...
        i.modalStack = [], i.modalStackClearQueue = function () {
            ...
            if (s) {
                ...
                if (i.params.modalActionsTemplate)i._compiledTemplates.actions || (i._compiledTemplates.actions = l.compile(i.params.modalActionsTemplate)), p = i._compiledTemplates.actions(a); else {
                    for (var u = "", f = 0; f < a.length; f++)for (var h = 0; h < a[f].length; h++) {
                        0 === h && (u += '<div class="actions-modal-group">');
                        var g = a[f][h], v = g.label ? "actions-modal-label" : "actions-modal-button";
            ...
            function n() {
                ...
                var d = a.outerWidth(), c = a.outerHeight(), u = a.offset(), f = a.parents(".page");
                f.length > 0 && (u.top = u.top - f[0].scrollTop);
                var m = o(window).height(), h = o(window).width(), g = 0, v = 0, w = 0, b = "top";
            ...
            if (e = o(e || ".modal-in"), "undefined" == typeof e || 0 !== e.length) {
                var a = e.hasClass("modal"), t = e.hasClass("popover"), n = e.hasClass("popup"), r = e.hasClass("login-screen"), s = e.hasClass("picker-modal"), l = e.hasClass("remove-on-close"), p = o(n ? ".popup-overlay" : ".modal-overlay");
            ...
            t.css({display: "block"}).addClass("active"), t.trigger("open"), t.find("." + i.params.viewClass).length > 0 && i.sizeNavbars && i.sizeNavbars(t.find("." + i.params.viewClass)[0]);
            ...
            function t(e) {
                ...
                s = !1, l = !1;
                var a, t = (new Date).getTime() - d, p = 0 === u || Math.abs(u) === m;
                if (a = f ? u === -m ? "reset" : 300 > t && Math.abs(u) >= 0 || t >= 300 && Math.abs(u) <= m / 2 ? "left" === r && u === m ? "reset" : "swap" : "reset" : 0 === u ? "reset" : 300 > t && Math.abs(u) > 0 || t >= 300 && Math.abs(u) >= m / 2 ? "swap" : "reset", "swap" === a && (i.allowPanelOpen = !0, f ? (i.closePanel(), p && (n.css({display: ""}), o("body").removeClass("panel-closing"))) : i.openPanel(r), p && (i.allowPanelOpen = !0)), "reset" === a)if (f)i.allowPanelOpen = !0, i.openPanel(r); else if (i.closePanel(), p)i.allowPanelOpen = !0, n.css({display: ""}); else {
                    var c = "reveal" === h ? b : n;
                    o("body").addClass("panel-closing"), c.transitionEnd(function () {
                        i.allowPanelOpen = !0, n.css({display: ""}), o("body").removeClass("panel-closing")
                    })
                }
                "reveal" === h && (b.transition(""), b.transform("")), n.transition("").transform(""), v.css({display: ""}).transform("")
            }
            ...
            var s, l, p, d, c, u, f, m, h, g, v = o(".panel-overlay"), w = {}, b = o("." + i.params.viewsClass);
        ...
        var h = function (e, a) {
            ...
            return r.params = a, r.container = o(e), 0 !== r.container.length ? (r.params.autoLayout && r.container.addClass("messages-auto-layout"), r.pageContainer = r.container.parents(".page").eq(0), r.pageContent = r.pageContainer.find(".page-content"), r.template = Template7.compile(r.params.messageTemplate), r.layout = function () {
                ...
                var l = [];
                if ("append" === a)for (n = o.length - e.length; n < o.length; n++)l.push(o[n]); else for (n = 0; n < e.length; n++)l.push(o[n]);
                return l
                ...
                var a = r.pageContent[0].scrollTop, t = r.params.newMessagesFirst ? 0 : r.pageContent[0].scrollHeight - r.pageContent[0].offsetHeight;
        ...
        i.messages = function (e, a) {
            ...
            function t(e) {
                if (r) {
                    ...
                    S = !1, P = !1;
                    var L;
                    if (f.length > 0)for (E = v / g, -g > v && (v = -g - Math.pow(-v - g, .8), k.length > 0 && (P = !0)), n = 0; n < y.length; n++)"undefined" == typeof y[n]._buttonOffset && (y[n]._buttonOffset = y[n].offsetLeft), p = y[n]._buttonOffset, L = o(y[n]), k.length > 0 && L.hasClass("swipeout-overswipe") && L.css({left: (P ? -p : 0) + "px"}), L.transform("translate3d(" + (v - p * (1 + Math.max(E, -1))) + "px,0,0)");
                    if (m.length > 0)for (E = v / h, v > h && (v = h + Math.pow(v - h, .8), T.length > 0 && (S = !0)), n = 0; n < C.length; n++)"undefined" == typeof C[n]._buttonOffset && (C[n]._buttonOffset = h - C[n].offsetLeft - C[n].offsetWidth), p = C[n]._buttonOffset, L = o(C[n]), T.length > 0 && L.hasClass("swipeout-overswipe") && L.css({left: (S ? p : 0) + "px"}), C.length > 1 && L.css("z-index", C.length - n), L.transform("translate3d(" + (v + p * (1 - Math.min(E, 1))) + "px,0,0)");
            ...
            function n(e) {
                ...
                if (T = "to-left" === x ? I : M, n = "to-left" === x ? f : m, t = "to-left" === x ? g : h, a = 300 > k && (-10 > d && "to-left" === x || d > 10 && "to-right" === x) || k >= 300 && Math.abs(v) > t / 2 ? "open" : "close", 300 > k && (0 === Math.abs(v) && (a = "close"), Math.abs(v) === t && (a = "open")), "open" === a) {
                    ...
                    var O = "to-left" === x ? -t : t;
                    if (u.transform("translate3d(" + O + "px,0,0)"), n.addClass("swipeout-actions-opened"), l = "to-left" === x ? y : C)for (b = 0; b < l.length; b++)o(l[b]).transform("translate3d(" + O + "px,0,0)");
                ...
                var E;
                if (C && C.length > 0 && C !== l)for (b = 0; b < C.length; b++)E = C[b]._buttonOffset, "undefined" == typeof E && (C[b]._buttonOffset = h - C[b].offsetLeft - C[b].offsetWidth), o(C[b]).transform("translate3d(" + E + "px,0,0)");
                if (y && y.length > 0 && y !== l)for (b = 0; b < y.length; b++)E = y[b]._buttonOffset, "undefined" == typeof E && (y[b]._buttonOffset = y[b].offsetLeft), o(y[b]).transform("translate3d(" + -E + "px,0,0)");
            ...
            function a(e) {
                if (n && p) {
                    ...
                    var t = l;
                    -u > t && (t = -u), t > f && (t = f), p.transform("translate3d(0," + t + "px,0)"), h = m = void 0, c.each(function () {
                        var e = o(this);
                        if (e[0] !== p[0]) {
            ...
            if (e = o(e), 0 !== e.length) {
                ...
                if (0 !== r.length && (r = r[0].f7View)) {
                    ...
                    if (!(w.disabled || e.hasClass("disabled") || b.hasClass("disabled"))) {
                        ...
                        var R = i._compiledTemplates.smartSelectItem, V = "";
                        if (!g)for (var F = 0; F < D.length; F++)V += R(D[F]);
                        ...
                        var j, _, X = "smart-select-" + A, U = "undefined" == typeof e.data("searchbar") ? i.params.smartSelectSearchbar : "true" === e.data("searchbar") ? !0 : !1;
                        U && (j = e.data("searchbar-placeholder") || "Search", _ = e.data("searchbar-cancel") || "Cancel");
                        var J, Q = '<form class="searchbar searchbar-init" data-search-list=".smart-select-list-' + B + '" data-search-in=".item-title"><div class="searchbar-input"><input type="search" placeholder="' + j + '"><a href="#" class="searchbar-clear"></a></div><a href="#" class="searchbar-cancel">' + _ + '</a></form><div class="searchbar-overlay"></div>', K = ("through" === q ? G : "") + '<div class="pages">  <div data-page="' + X + '" data-select-name="' + z + '" class="page smart-select-page ' + Y + " " + W + '">' + ("fixed" === q ? G : "") + (U ? Q : "") + '    <div class="page-content">' + ("static" === q ? G : "") + '      <div class="list-block ' + (g ? "virtual-list" : "") + " smart-select-list-" + B + " " + (m ? "theme-" + m : "") + '">        <ul>' + (g ? "" : V) + "        </ul>      </div>    </div>  </div></div>";
        ...
        var g = function (e, a) {
            ...
            var p, d, c, u, f, m, h = 0, g = "function" == typeof r.params.height;
            return r.setListSize = function () {
                ...
                if ("undefined" != typeof a && (t = a), null === r.lastRepaintY || Math.abs(t - r.lastRepaintY) > h || !s && r.pageContent[0].scrollTop + p >= r.pageContent[0].scrollHeight) {
                    ...
                    for (var b = n; i > b; b++) {
                        var C, y;
                        y = r.items.indexOf(o[b]), b === n && (r.currentFromIndex = y), b === i - 1 && (r.currentToIndex = y), y === r.items.length - 1 && (r.reachEnd = !0), r.domCache[y] ? C = r.domCache[y] : (r.tempDomElement.innerHTML = r.template ? r.template(o[b], {index: y}) : r.params.renderItem ? r.params.renderItem(y, o[b]) : o[b], C = r.tempDomElement.childNodes[0], r.params.cache && (r.domCache[y] = C)), C.f7VirtualListIndex = y, b === n && (w = g ? l : b * r.params.height / r.params.cols), C.style.top = w + "px", r.params.onItemBeforeInsert && r.params.onItemBeforeInsert(r, C), r.fragment.appendChild(C)
                    }
        ...
        i.virtualList = function (e, a) {
            ...
            if (l.hasClass("pull-to-refresh-content") || (l = l.find(".pull-to-refresh-content")), l && 0 !== l.length) {
                var p, d, c, u, f, m, h, g, v, w, b, C = {}, y = !1, x = !1, T = 0, k = l.hasClass("page") ? l : l.parents(".page"), S = !1;
            ...
            if (0 !== t.length) {
                ...
                if (n || r || s) {
                    ...
                    if (0 !== l.length) {
                        ...
                        var u, f, m = d.length > 0, h = c.length > 0, g = p && p.length > 0;
                        u = f = t[0].scrollTop;
                        var v, w, b, C, y, x, T, k = h && r ? c[0].offsetHeight : 0, S = g && s ? p[0].offsetHeight : 0, P = S || k;
            ...
            function e(e) {
                var a, t = o(e.target), n = t.parents(i.params.activeStateElements);
            ...
            function a(e) {
                ...
                var m;
                if (a.hasClass("tab-link") && (m = !0, i.showTab(r.tab || a.attr("href"), a)), a.hasClass("swipeout-close") && i.swipeoutClose(a.parents(".swipeout-opened")), a.hasClass("swipeout-delete"))if (r.confirm) {
                ...
                if ((!i.params.ajaxLinks || a.is(i.params.ajaxLinks)) && n && i.params.router) {
                    n && e.preventDefault();
                    var w = t && t.length > 0 && "#" !== t && !m, b = r.template;
            ...
            var t = o(e), n = t.find(".swiper-init");
            ...
            var a = o(e), t = a.find(".swiper-init");
            if (0 !== t.length)for (var n = 0; n < t.length; n++) {
                var r = t[0].swiper;
                r && r.update(!0)
            }
        ...
        var v = function (e) {
            ...
            var M, I, O, E, L, D, B, N, A, z, H, R, V, F, q, G, Y, W = {}, j = {};
            t.onSlideTouchStart = function (e) {
                ...
                if (x && 0 !== x.length) {
                    ...
                    M = !1, I = !1;
                    var a = 300, n = 300, r = q * a, i = O + r, s = Y * n, o = E + s;
            ...
            return t.swipeCloseTouchStart = function (e, a) {
                ...
                $ = !1, Z = !1;
                var n = Math.abs(_), r = (new Date).getTime() - Q;
        ...
        var w = function (e) {
            ...
            return p.setValue = function (e, a) {
                ...
                var d = o(e), c = d.index(), f = p.cols[c];
                if (!f.divider) {
                    ...
                    f.replaceValues = function (e, a) {
                        ...
                        var e, a;
                        e = 0, a = f.container[0].offsetHeight, m = f.wrapper[0].offsetHeight, h = f.items[0].offsetHeight, g = h * f.items.length, v = a / 2 - g + h / 2, w = a / 2 - h / 2, f.width && (e = f.width, parseInt(e, 10) === e && (e += "px"), f.container.css({width: e})), p.params.rotateEffect && (f.width || (f.items.each(function () {
                            var a = o(this);
                    ...
                    f.setValue = function (e, a, n) {
                        ...
                        if ((n || "undefined" == typeof n) && (f.value = i.attr("data-picker-value"), f.displayValue = f.displayValues ? f.displayValues[e] : f.value, r !== e && (f.onChange && f.onChange(p, f.value, f.displayValue), p.updateValue())), p.params.rotateEffect) {
                            ...
                            f.items.each(function () {
                                var e = o(this), t = e.index() * h, n = w - a, r = t - n, i = r / h, s = Math.ceil(f.height / h / 2) + 1, l = -18 * i;
        ...
        var b = function (e) {
            ...
            return p.animating = !1, p.addValue = function (e) {
                ...
                0 === s && (s = 7);
                var o, l, d, c = [], u = 6, f = 7, m = "", h = 0 + (p.params.firstDay - 1), g = (new Date).setHours(0, 0, 0, 0), v = p.params.minDate ? new Date(p.params.minDate).getTime() : null, w = p.params.maxDate ? new Date(p.params.maxDate).getTime() : null;
    ...
    var e = function () {
        ...
        return a.ajax = function (e) {
            ...
            if ("json" === e.dataType && e.url.indexOf("callback=") >= 0) {
                var d, c = "f7jsonp_" + Date.now() + n++, u = e.url.split("callback="), f = u[0] + "callback=" + c;
                if (u[1].indexOf("&") >= 0) {
            ...
            if (("POST" === l || "PUT" === l) && e.data)if (e.processData) {
                ...
                if (w.indexOf(e.data.constructor) >= 0)v = e.data; else {
            ...
            return 4 === arguments.length && "function" == typeof r && (i = r, r = void 0), this.each(function () {
                function s(e) {
                    ...
                    var t, p = Math.max(Math.min((e - w) / n, 1), 0), d = "linear" === r ? p : .5 - Math.cos(p * Math.PI) / 2;
                ...
                var o, l, p, d, c, u, f, m, h = this, g = t > 0 || 0 === t, v = e > 0 || 0 === e;
    ...
    window.Dom7 = e, Framework7.prototype.support = function () {
        ...
        function n(a) {
            ...
            for (n = 0; n < s.length; n++) {
                ...
                if ("" !== o)if (o.indexOf("{{") < 0)i.push({type: "plain", content: o}); else {
                    ...
                    if (o.indexOf("{#") >= 0) {
                        var f, m = "", h = "", g = 0, v = !1, w = !1, b = 0;
                        for (r = n + 1; r < s.length; r++)if (s[r].indexOf("{{#") >= 0 && b++, s[r].indexOf("{{/") >= 0 && b--, s[r].indexOf("{{#" + p) >= 0)m += s[r], w && (h += s[r]), g++; else if (s[r].indexOf("{{/" + p) >= 0) {
                            if (!(g > 0)) {
                                f = r, v = !0;
                                break
                            }
                    ...
                    } else o.indexOf(" ") > 0 && i.push({type: "helper", helperName: p, contextName: d, hash: c})
                }
            }
            return i
        }
        ...
        var r = function (e) {
            ...
            function s(e, s) {
                ...
                for (c = 0; c < l.length; c++) {
                    ...
                    if ("plain" !== u.type) {
                        var f, m;
                        if ("variable" === u.type && (f = r(u.contextName, p), d += "r += c(" + f + ", " + p + ");"), "helper" === u.type)if (u.helperName in o.helpers)m = i(u.contextName, p), d += "r += (Template7.helpers." + u.helperName + ").call(" + p + ", " + (m && m + ", ") + "{hash:" + JSON.stringify(u.hash) + ", data: data || {}, fn: " + a(u, s + 1) + ", inverse: " + t(u, s + 1) + ", root: ctx_1});"; else {
        ...
        t = t || {};
        for (var c in p)if ("undefined" == typeof t[c])t[c] = p[c]; else if ("object" == typeof t[c])for (var u in p[c])"undefined" == typeof t[c][u] && (t[c][u] = p[c][u]);
        var f = this;
        ...
        if (m = "undefined" == typeof e ? window.Dom7 || window.Zepto || window.jQuery : e, m && (f.$ = m, f.container = m(a), 0 !== f.container.length)) {
            ...
            f.container[0].swiper = f, f.container.data("swiper", f), f.classNames.push("swiper-container-" + f.params.direction), f.params.freeMode && f.classNames.push("swiper-container-free-mode"), f.support.flexbox || (f.classNames.push("swiper-container-no-flexbox"), f.params.slidesPerColumn = 1), (f.params.parallax || f.params.watchSlidesVisibility) && (f.params.watchSlidesProgress = !0), ["cube", "coverflow"].indexOf(f.params.effect) >= 0 && (f.support.transforms3d ? (f.params.watchSlidesProgress = !0, f.classNames.push("swiper-container-3d")) : f.params.effect = "slide"), "slide" !== f.params.effect && f.classNames.push("swiper-container-" + f.params.effect), "cube" === f.params.effect && (f.params.resistanceRatio = 0, f.params.slidesPerView = 1, f.params.slidesPerColumn = 1, f.params.slidesPerGroup = 1, f.params.centeredSlides = !1, f.params.spaceBetween = 0, f.params.virtualTranslate = !0, f.params.setWrapperSize = !1), "fade" === f.params.effect && (f.params.slidesPerView = 1, f.params.slidesPerColumn = 1, f.params.slidesPerGroup = 1, f.params.watchSlidesProgress = !0, f.params.spaceBetween = 0, "undefined" == typeof d && (f.params.virtualTranslate = !0)), f.params.grabCursor && f.support.touch && (f.params.grabCursor = !1), f.wrapper = f.container.children("." + f.params.wrapperClass), f.params.pagination && (f.paginationContainer = m(f.params.pagination), f.params.paginationClickable && f.paginationContainer.addClass("swiper-pagination-clickable")), f.rtl = n() && ("rtl" === f.container[0].dir.toLowerCase() || "rtl" === f.container.css("direction")), f.rtl && f.classNames.push("swiper-container-rtl"), f.rtl && (f.wrongRTL = "-webkit-box" === f.wrapper.css("display")), f.params.slidesPerColumn > 1 && f.classNames.push("swiper-container-multirow"), f.device.android && f.classNames.push("swiper-container-android"), f.container.addClass(f.classNames.join(" ")), f.translate = 0, f.progress = 0, f.velocity = 0, f.lockSwipeToNext = function () {
                ...
                var e, a = f.params.spaceBetween, t = 0, r = 0, i = 0;
                ...
                for (e = 0; e < f.slides.length; e++) {
                    ...
                    if (f.params.slidesPerColumn > 1) {
                        ...
                        "column" === f.params.slidesPerColumnFill ? (d = Math.floor(e / m), c = e - d * m, p = d + c * s / m, l.css({
                            ...
                            "-webkit-order": p,
                            order: p
                        })) : (u = s / m, c = Math.floor(e / u), d = e - c * u), l.css({"margin-top": 0 !== c && f.params.spaceBetween && f.params.spaceBetween + "px"}).attr("data-swiper-column", d).attr("data-swiper-row", c)
                    }
                ...
                0 === f.snapGrid.length && (f.snapGrid = [0]), 0 !== f.params.spaceBetween && f.slides.css(n() ? f.rtl ? {marginLeft: a + "px"} : {marginRight: a + "px"} : {marginBottom: a + "px"}), f.params.watchSlidesProgress && f.updateSlidesOffset()
                ...
                if ("undefined" == typeof e && (e = f.translate || 0), 0 !== f.slides.length) {
                    ...
                    for (var t = 0; t < f.slides.length; t++) {
                        var r = f.slides[t], i = f.params.centeredSlides === !0 ? r.swiperSlideSize / 2 : 0, s = (a - r.swiperSlideOffset - i) / (r.swiperSlideSize + f.params.spaceBetween);
                        if (f.params.watchSlidesVisibility) {
                            var o = -(a - r.swiperSlideOffset - i), l = o + f.slidesSizesGrid[t], p = o >= 0 && o < f.size || l > 0 && l <= f.size || 0 >= o && l >= f.size;
            ...
            window.navigator.pointerEnabled ? h = ["pointerdown", "pointermove", "pointerup"] : window.navigator.msPointerEnabled && (h = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), f.touchEvents = {
                ...
                var a = e ? "off" : "on", n = e ? "removeEventListener" : "addEventListener", r = "container" === f.params.touchEventsTarget ? f.container[0] : f.wrapper[0], i = f.support.touch ? r : document, s = f.params.nested ? !0 : !1;
                ...
                var a = i(e, "." + f.params.slideClass), t = !1;
                if (a)for (var n = 0; n < f.slides.length; n++)f.slides[n] === a && (t = !0);
                ...
                if (f.clickedSlide = a, f.clickedIndex = m(a).index(), f.params.slideToClickedSlide && void 0 !== f.clickedIndex && f.clickedIndex !== f.activeIndex) {
                    ...
                    if (f.params.loop)if (r = m(f.clickedSlide).attr("data-swiper-slide-index"), s > f.slides.length - f.params.slidesPerView)f.fixLoop(), s = f.wrapper.children("." + f.params.slideClass + '[data-swiper-slide-index="' + r + '"]').eq(0).index(), setTimeout(function () {
                        f.slideTo(s)
            ...
            var g, v, w, b, C, y, x, T, k, S = "input, select, textarea, button", P = Date.now(), M = [];
            ...
            f.onTouchStart = function (e) {
                ...
                if (e.originalEvent && (e = e.originalEvent), f.emit("onTouchEnd", f, e), g) {
                    ...
                    if (n = f.params.followFinger ? f.rtl ? f.translate : -f.translate : -C, f.params.freeMode) {
                        ...
                        if (f.params.freeModeMomentum) {
                            if (M.length > 1) {
                                var r = M.pop(), i = M.pop(), s = r.position - i.position, o = r.time - i.time;
                            ...
                            f.rtl && (d = -d);
                            var c, u = !1, h = 20 * Math.abs(f.velocity) * f.params.freeModeMomentumBounceRatio;
                            if (d < f.maxTranslate())f.params.freeModeMomentumBounce ? (d + f.maxTranslate() < -h && (d = f.maxTranslate() - h), c = f.maxTranslate(), u = !0, k = !0) : d = f.maxTranslate(); else if (d > f.minTranslate())f.params.freeModeMomentumBounce ? (d - f.minTranslate() > h && (d = f.minTranslate() + h), c = f.minTranslate(), u = !0, k = !0) : d = f.minTranslate(); else if (f.params.freeModeSticky) {
                                var b, x = 0;
                                for (x = 0; x < f.snapGrid.length; x += 1)if (f.snapGrid[x] > -d) {
                                    b = x;
                                    break
                                }
                                d = Math.abs(f.snapGrid[b] - d) < Math.abs(f.snapGrid[b - 1] - d) || "next" === f.swipeDirection ? f.snapGrid[b] : f.snapGrid[b - 1], f.rtl || (d = -d)
                            }
                            if (0 !== f.velocity)l = Math.abs(f.rtl ? (-d - f.translate) / f.velocity : (d - f.translate) / f.velocity); else if (f.params.freeModeSticky)return void f.slideReset();
                    ...
                    var S, I = 0, O = f.slidesSizesGrid[0];
                ...
                if (f.params.observeParents)for (var e = f.container.parents(), a = 0; a < e.length; a++)s(e[a]);
                s(f.container[0], {childList: !1}), s(f.wrapper[0], {attributes: !1})
                ...
                fade: {
                    fadeIndex: null, setTranslate: function () {
                        for (var e = 0; e < f.slides.length; e++) {
                            ...
                            s > 0 && 1 > s && (f.effects.fade.fadeIndex = e), a.css({opacity: s}).transform("translate3d(" + r + "px, " + i + "px, 0px)")
                        }
                        ...
                        if (f.slides.transition(e), f.params.virtualTranslate && 0 !== e) {
                            ...
                            f.params.loop || f.params.fade.crossFade || 0 !== a || (a = f.slides.length - 1), f.slides.eq(a).transitionEnd(function () {
                                if (f)for (var e = ["webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd"], a = 0; a < e.length; a++)f.wrapper.trigger(e[a])
                            })
                        }
                    }
                }, cube: {
                    setTranslate: function () {
                        var e, a = 0;
                        f.params.cube.shadow && (n() ? (e = f.wrapper.find(".swiper-cube-shadow"), 0 === e.length && (e = m('<div class="swiper-cube-shadow"></div>'), f.wrapper.append(e)), e.css({height: f.width + "px"})) : (e = f.container.find(".swiper-cube-shadow"), 0 === e.length && (e = m('<div class="swiper-cube-shadow"></div>'), f.container.append(e))));
                        for (var t = 0; t < f.slides.length; t++) {
                            var r = f.slides.eq(t), i = 90 * t, s = Math.floor(i / 360);
                            ...
                            if (1 >= o && o > -1 && (a = 90 * t + 90 * o, f.rtl && (a = 90 * -t - 90 * o)), r.transform(c), f.params.cube.slideShadows) {
                                var u = r.find(n() ? ".swiper-slide-shadow-left" : ".swiper-slide-shadow-top"), h = r.find(n() ? ".swiper-slide-shadow-right" : ".swiper-slide-shadow-bottom");
                        ...
                        if (f.wrapper.css({
                            ...
                            }), f.params.cube.shadow)if (n())e.transform("translate3d(0px, " + (f.width / 2 + f.params.cube.shadowOffset) + "px, " + -f.width / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + f.params.cube.shadowScale + ")"); else {
                            var g = Math.abs(a) - 90 * Math.floor(Math.abs(a) / 90), v = 1.5 - (Math.sin(2 * g * Math.PI / 360) / 2 + Math.cos(2 * g * Math.PI / 360) / 2), w = f.params.cube.shadowScale, b = f.params.cube.shadowScale / v, C = f.params.cube.shadowOffset;
                    ...
                    setTranslate: function () {
                        for (var e = f.translate, a = n() ? -e + f.width / 2 : -e + f.height / 2, t = n() ? f.params.coverflow.rotate : -f.params.coverflow.rotate, r = f.params.coverflow.depth, i = 0, s = f.slides.length; s > i; i++) {
                            var o = f.slides.eq(i), l = f.slidesSizesGrid[i], p = o[0].swiperSlideOffset, d = (a - p - l / 2) / l * f.params.coverflow.modifier, c = n() ? t * d : 0, u = n() ? 0 : t * d, h = -r * Math.abs(d), g = n() ? 0 : f.params.coverflow.stretch * d, v = n() ? f.params.coverflow.stretch * d : 0;
                            ...
                            if (o.transform(w), o[0].style.zIndex = -Math.abs(Math.round(d)) + 1, f.params.coverflow.slideShadows) {
                                var b = o.find(n() ? ".swiper-slide-shadow-left" : ".swiper-slide-shadow-top"), C = o.find(n() ? ".swiper-slide-shadow-right" : ".swiper-slide-shadow-bottom");
                ...
                initialImageLoaded: !1, loadImageInSlide: function (e, a) {
                    if ("undefined" != typeof e && ("undefined" == typeof a && (a = !0), 0 !== f.slides.length)) {
                        var t = f.slides.eq(e), n = t.find(".swiper-lazy:not(.swiper-lazy-loaded):not(.swiper-lazy-loading)");
                ...
                set: function () {
                    ...
                    if (f.params.scrollbar) {
                        var e, a = f.scrollbar, t = (f.translate || 0, a.dragSize);
                ...
                setTranslate: function (e, a) {
                    ...
                    if (f.isArray(i))for (var s = 0; s < i.length; s++)i[s] !== a && i[s]instanceof Swiper && t(i[s]); else i instanceof Swiper && a !== i && t(i)
                    ...
                    if (f.isArray(r))for (n = 0; n < r.length; n++)r[n] !== a && r[n]instanceof Swiper && t(r[n]); else r instanceof Swiper && a !== r && t(r)
                }
            }, f.parallax = {
                setTranslate: function () {
